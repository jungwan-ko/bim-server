...
import com.web.base.account.service.AccountServiceImpl;
...
@Aspect
public class ControllerAopOld {
	private static final Logger logger = LoggerFactory.getLogger(ControllerAopOld.class);
	@Autowired
	...
	@Before("execution(* com.web.base.admin..*Controller.*Action(..)) "
			+ "|| execution(* com.web.base.admin..*Controller.*View(..)) "
			)
	public void preAction(JoinPoint joinPoint) throws Throwable {
		...
		boolean isAdmin=signature.toString().indexOf("com.web.base")>-1;
	...
	@After("execution(* com.web.base.admin..*Controller.*Action(..)) || execution(* com.web.base.admin..*Controller.*View(..)) ")
